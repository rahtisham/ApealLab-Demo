    ...
    <div class="container" style="margin-top: 30px;">
        ...
        <div class="row">
            @foreach($integrationData as $walmart)
                <div class="col-xl-4">
                        <a href="{{ url('dashboard/integration-listening-view' , ['id' => $walmart->id]) }}">
                            <div class="card HoverCard bg-image-walmart">
                                <div class="card-header">
                                    <button type="button" class="btn btn-success btn-xxs">{{ $walmart->status }}</button>
                                </div>
                                <div class="pdleft">
            ...
            <div class="col-xl-4">
                <a href="{{ url('dashboard/select-marketplace') }}">
