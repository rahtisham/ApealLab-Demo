                    ...
                    <div class="profile-head">
                        ...
                        <div class="profile-info">
                            <div class="profile-photo">
                                <img src="{{ asset('AppealLab/images/profile/profile.png') }}" class="img-fluid rounded-circle" alt="">
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="profile-blog mb-5">
                            ...
                            <img src="{{ asset('AppealLab/images/profile/1.jpg') }}" alt="" class="img-fluid mt-4 mb-4 w-100">
                        ...
                        <div class="profile-interest mb-5">
                            ...
                            <div class="row mt-4 sp4" id="lightgallery">
                                <a href="{{ asset('AppealLab/images/profile/2.jpg') }}" data-exthumbimage="images/profile/2.jpg" data-src="images/profile/2.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                    <img src="{{ asset('AppealLab/images/profile/2.jpg') }}" alt="" class="img-fluid">
                                </a>
                                <a href="{{ asset('AppealLab/images/profile/3.jpg') }}" data-exthumbimage="images/profile/3.jpg" data-src="images/profile/3.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                    <img src="{{ asset('AppealLab/images/profile/3.jpg') }}" alt="" class="img-fluid">
                                </a>
                                <a href="{{ asset('AppealLab/images/profile/4.jpg') }}" data-exthumbimage="images/profile/4.jpg" data-src="images/profile/4.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                    <img src="{{ asset('AppealLab/images/profile/4.jpg') }}" alt="" class="img-fluid">
                                </a>
                                <a href="{{ asset('AppealLab/images/profile/3.jpg') }}" data-exthumbimage="images/profile/3.jpg" data-src="images/profile/3.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                    <img src="{{ asset('AppealLab/images/profile/3.jpg') }}" alt="" class="img-fluid">
                                </a>
                        ...
                        <div class="profile-news">
                            ...
                            <div class="media pt-3 pb-3">
                                <img src="{{ asset('AppealLab/images/profile/5.jpg') }}" alt="image" class="mr-3 rounded" width="75">
                            ...
                            <div class="media pt-3 pb-3">
                                <img src="{{ asset('AppealLab/images/profile/6.jpg') }}" alt="image" class="mr-3 rounded" width="75">
                                <div class="media-body">
                                    <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection of textile samples</a></h5>
                                    <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                                </div>
                            ...
                            <div class="media pt-3 pb-3">
                                <img src="{{ asset('AppealLab/images/profile/7.jpg') }}" alt="image" class="mr-3 rounded" width="75">
                                <div class="media-body">
                                    <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection of textile samples</a></h5>
                                    <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                                </div>
                                    ...
                                    <div id="my-posts" class="tab-pane fade active show">
                                        <div class="my-post-content pt-3">
                                            ...
                                            <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                <img src="{{ asset('AppealLab/images/profile/8.jpg') }}" alt="" class="img-fluid">
                                            ...
                                            <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                <img src="{{ asset('AppealLab/images/profile/9.jpg') }}" alt="" class="img-fluid">
                                                <a class="post-title" href="post-details.html"><h3 class="text-black">Collection of textile samples lay spread</h3></a>
                                                <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
                                                    of spare which enjoy whole heart.</p>
                                                <button class="btn btn-primary mr-2"><span class="mr-2"><i
